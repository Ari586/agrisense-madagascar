...
const Farm3D = dynamic(() => import('./farm-3d').then(mod => mod.Farm3D), {
  ssr: false,
  loading: () => (
    <div className="w-full h-[400px] flex items-center justify-center bg-black/20 rounded-2xl border border-white/10">
